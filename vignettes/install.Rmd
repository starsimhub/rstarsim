...
Now that Starsim is installed, see the [Simple usage](simple.html) tutorial to create and run your first simulation. If you run into problems, check the [Troubleshooting](troubleshooting.html) guide.
